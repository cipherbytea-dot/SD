// ============================================================
// E-TAKZIR V1: Implementasi Antarmuka Grafis Qt (GUI)
// FIX: Penambahan validasi NIS tidak ditemukan sebelum eksekusi
...
void AntarmukaUtama::bangunHalamanPimpinan() {
    ...
    kotakNamaAturan->setMaxLength(49);
...
void AntarmukaUtama::bangunHalamanPengurus() {
    ...
    kotakKeteranganPelanggaran->setMaxLength(99);
